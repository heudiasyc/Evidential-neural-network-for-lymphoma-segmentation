    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(model.state_dict(), "RBF_best_metric_model_segmentation3d_dict_test_1e-2.pth")
...
model.load_state_dict(torch.load("RBF_best_metric_model_segmentation3d_dict.pth"))
model.eval()
#############################################
...
path_results='/home/lab/hualing/(IJAR_new)hl_medical-segmentation-master/result_rbf'  #### result folder
# generates folders
...
def PREDICT_MASK(data_set_ids, path_predictions, model):
    ...
    os.chdir(r'/home/lab/hualing/(IJAR_new)hl_medical-segmentation-master/result_rbf')
    ...
    for i,val_data in enumerate(val_loader):
        ...
        prediction=prediction.permute(0,3,2,1)#
